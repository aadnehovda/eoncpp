...
namespace eon
{
	EON_TEST( vector, vector, init,
		EON_EQ( "a,b,c,d", string( "," ).join( vector<string>( EON_CSC( "a", "b", "c", "d" ) ) ) ) );
	...
	EON_TEST_2STEP( vector, vector, iterators,
		std::vector<string> input EON_CSC( "a", "b", "c", "d" ),
	...
	EON_TEST_3STEP( vector, clear, basic,
		vector<int> obj EON_CSC( 1, 2, 3, 4 ),
		obj.clear(),
	...
	EON_TEST_3STEP( vector, insert, front,
		vector<string> obj EON_CSC( "a", "b", "c", "d" ),
		obj.insert( 0, "x" ),
	...
	EON_TEST_3STEP( vector, remove, multiple,
		vector<string> obj EON_CSC( "a", "b", "c", "d", "e" ),
		obj.remove( 2 ),
	...
	EON_TEST_3STEP( vector, operator_subscr, basic,
		vector<int> obj EON_CSC( 2, 4, 6, 8, 10 ),
		obj[ 2 ] = 5,
		EON_EQ( 5, obj[ 2 ] ) );
	...
	EON_TEST( vector, operator_bool, true,
		EON_TRUE( vector<int> EON_CSC( 1, 2, 3 ) ) );
	...
	EON_TEST_2STEP( vector, lastPos, many,
		vector<int> obj EON_CSC( 1, 2, 3, 4, 5 ),
