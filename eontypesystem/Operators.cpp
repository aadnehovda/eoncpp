		...
		void Operators::_prep()
		{
			if( Details.empty() )
			{
				Details = {
					...
					{ name_for_each, OperatorDetails( { OperatorElement( name_for ), OperatorElement( name_each, true ), OperatorElement( name_in ) }, 3, Precedence::min_hi, Precedence::min_lo ) },
					{ name_for_each_where, OperatorDetails( { OperatorElement( name_for ), OperatorElement( name_each, true ), OperatorElement( name_in ), OperatorElement( name_where ) }, 4, Precedence::min_hi, Precedence::min_lo ) },
					...
					{ name_is_not, OperatorDetails( { OperatorElement( name_is ), OperatorElement( name_not, true ) }, 2, Precedence::peta_lo, Precedence::peta_hi ) },
					{ name_size_of, OperatorDetails( { OperatorElement( name_size ), OperatorElement( name_of, true ) }, 1, Precedence::peta_hi, Precedence::peta_lo ) },
					...
					{ name_reset, OperatorDetails( { OperatorElement( name_reset, true ) }, 1, Precedence::max_hi, Precedence::max_lo ) },
					{ name_unary_minus, OperatorDetails( { OperatorElement( name_unary_minus, true ) }, 1, Precedence::peta_hi, Precedence::peta_lo ) },
					{ name_not, OperatorDetails( { OperatorElement( name_not, true ) }, 1, Precedence::peta_hi, Precedence::peta_lo ) },
					...
					{ symbol_bitnot, OperatorDetails( { OperatorElement( symbol_bitnot, true ) }, 1, Precedence::peta_hi, Precedence::peta_lo ) },
					...
					{ symbol_pct_of, OperatorDetails( { OperatorElement( symbol_pct ), OperatorElement( name_of, true ) }, 2, Precedence::kilo_lo, Precedence::kilo_hi ) },
					{ symbol_as_pct_of, OperatorDetails( { OperatorElement( name_as ), OperatorElement( symbol_pct, true ), OperatorElement( name_of, true ) }, 2, Precedence::kilo_lo, Precedence::kilo_hi ) },

					{ name_retblank, OperatorDetails( { name_return }, 0, Precedence::max_hi, Precedence::max_lo ) },
					{ name_retvalue, OperatorDetails( { OperatorElement( name_return, true ) }, 1, Precedence::max_hi, Precedence::max_lo ) },
					...
					{ name_bumpcall, OperatorDetails( { OperatorElement( name_bumpcall, true ) }, 1, Precedence::max_hi, Precedence::max_lo ) },
					{ name_raise, OperatorDetails( { OperatorElement( name_raise, true ) }, 1, Precedence::min_hi, Precedence::min_lo ) },
					{ name_call, OperatorDetails( { OperatorElement( name_call, true ) }, 1, Precedence::exa_hi, Precedence::exa_lo ) },
